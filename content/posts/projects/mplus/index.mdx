...
After a period of operation, when measuring the satisfaction of customers who experience the home loan journey with the M+ process, the score is **88.1%**. Ratio of approved profiles compared to initialization records reaches **96%**.
...
The project helps customers to check their contracts, required documents before signing, even the disbursement stage is automated.
