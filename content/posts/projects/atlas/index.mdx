...
date: 2018-08-01
banner: ./banner.jpg
description: To learn more about food delivery market and support a new startup to enter the market, we conduct a market survey, analysis and evaluation of solutions. Along with that is the construction of a food delivery service (web & mobile apps).
tags:
  - project
  - food-delivery
  - restaurant
...
- Collaborate to define the product, interface with many stakeholders to drive product decisions
...
- Work on Front-end development using React Native
- Interact with the backend and design team members
- Responsible for code reviews & writing testable code
- Take part in continuous integration
- Successfully develop and launch a new mobile driver app to real life in 2 weeks
- Build a complete platform for food delivery service that includes customer app, driver app, restaurant app & call centres in one month
